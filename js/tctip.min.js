...
tctip = window.tctip || {
    myConfig: {
        ...
        siderTop: "10%",
        buttomText: "储物间备用站",
        buttomLink: "http://kyon945.ysepan.com/"
    },
    myRewards: null,
    myRewardsBtn: null,
    myRewardsMain: null,
    ...
    generateMyRewardsMain: function() {
        ...
        f = {
            href: tctip.myConfig.buttomLink || "http://kyon945.ysepan.com/",
            target: "_blank"
        }, f[tctipUtil.getTextKey()] = tctip.myConfig.buttomText || "储物间备用站", tctipUtil.createElement(f, "a", e)
    },
    ...
    generateMyRewardsDetail: function() {
        ...
        if (tctip.currentData.hasOwnProperty("text")) {
            ...
            d[tctipUtil.getTextKey()] = "扫描二维码支持阿虚", tctipUtil.createElement(d, "p", this.myRewardsUbox);
